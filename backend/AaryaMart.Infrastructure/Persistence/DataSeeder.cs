...
namespace AaryaMart.Infrastructure.Persistence;
...
public static class DataSeeder
{
    ...
    public static async Task SeedAsync(ApplicationDbContext context, IServiceProvider serviceProvider)
    {
        ...
        {
            logger?.LogInformation("[AaryaMart PostgreSQL] Seeding initial products...");
        ...
        var adminEmail = "admin@aaryamart.in";
        if (!await context.Users.AnyAsync(u => u.Email == adminEmail))
        {
            logger?.LogInformation("[AaryaMart PostgreSQL] Seeding administrative and demo accounts...");
        ...
        {
            logger?.LogInformation("[AaryaMart PostgreSQL] Seeding default coupons...");
        ...
        {
            logger?.LogInformation("[AaryaMart PostgreSQL] Seeding default saved addresses...");
        ...
        logger?.LogInformation("[AaryaMart PostgreSQL] Data seeding completed successfully.");
    }
    ...
    private static SeedDataSnapshot? TryLoadSnapshot()
    {
        var candidatePaths = new[]
        {
            ...
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "AaryaMart.Infrastructure", "Persistence", "seed_data.json"),
